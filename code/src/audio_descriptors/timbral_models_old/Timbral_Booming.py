...
def boominess_calculate(loudspec):
    ...
    FR = [
        ...
        12500
    ]  # get the centre frequencies of 3rd octave bands
...
def timbral_booming(fname,
    ...
    if mean:
        rms_boom = np.average(windowed_booming,
    ...
    if dev_output:
        ...
        coefficients = np.array(
            [43.67402696195865, -10.90054738389845,
             26.836530575185435])[:, np.newaxis]
