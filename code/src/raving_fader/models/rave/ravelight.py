...
from raving_fader.models.rave.networks import Encoder, Generator, StackDiscriminators
from raving_fader.models.rave.pqmf import PQMF
...
class RAVELight(pl.LightningModule):
    def __init__(self,
                 data_size,
                 capacity,
                 latent_size,
