...
def timbral_sharpness(fname, dev_output=False, phase_correction=False, clip_output=False, fs=0, mean=False):
    """
    ...
    if dev_output:
        ...
        coefficients = np.array([102.50508921364404, 34.432655185001735])[:,np.newaxis]
